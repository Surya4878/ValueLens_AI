    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        {platforms.map((p) => (
          ...
          >
            ...
            <div className="flex items-center justify-center sm:justify-start space-x-3 bg-gradient-to-br from-slate-50/80 to-blue-50/40 p-4 rounded-xl border border-slate-100 shrink-0 min-w-[210px]">
              ...
              {/* Dashed Arrow */}
              <div className="flex flex-col items-center px-0.5 text-blue-400">
              ...
              <div className="w-20 h-20 bg-white rounded-xl border border-blue-200/80 p-2 flex flex-col items-center justify-center shadow-2xs group-hover:scale-105 transition-transform">
                ...
                <span className="text-[9.5px] font-extrabold text-[#0066cc] text-center leading-tight">
            ...
            <div className="flex-1 flex flex-col justify-between space-y-4">
              ...
              <div className="pt-1">
                <Link
                  ...
                  className="inline-flex items-center space-x-1.5 px-4 py-2 rounded-lg text-xs font-bold text-[#0066cc] bg-blue-50/60 hover:bg-[#0066cc] hover:text-white border border-[#0066cc]/40 hover:border-[#0066cc] shadow-2xs transition-all w-fit group/btn cursor-pointer"
                >
      ...
      <section className="rounded-2xl bg-white border border-blue-100/90 p-5 sm:p-6 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-5">
        <div className="flex items-center space-x-4">
          {/* Blue Circle Icon */}
          <div className="w-12 h-12 rounded-2xl bg-blue-50 text-[#0066cc] border border-blue-100 flex items-center justify-center shrink-0 shadow-2xs">
        ...
        <Link
          href="/assessment"
          className="inline-flex items-center justify-center space-x-1.5 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold bg-[#7928ca] hover:bg-[#6820b0] text-white shadow-xs transition-colors shrink-0 whitespace-nowrap cursor-pointer"
        >
