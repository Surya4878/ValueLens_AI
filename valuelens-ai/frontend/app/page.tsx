...
export default function HomePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10 space-y-12 text-[#1d2d3e]">
      {/* 1. Hero Section */}
      ...
      <section className="bg-white rounded-3xl border border-[#d9e2ec] p-8 md:p-10 shadow-xs">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Badge 1 */}
          <div className="flex items-start space-x-4">
            <div className="w-12 h-12 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-[#0070f2] shrink-0 mt-0.5">
