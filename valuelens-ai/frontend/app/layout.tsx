  ...
  return (
    <html lang="en">
      <body className="min-h-screen flex flex-col bg-[#f5f6f7] text-[#1d2d3e] font-sans antialiased selection:bg-[#e5f0ff] selection:text-[#0070f2]">
        ...
        <footer className="no-print bg-white border-t border-[#d9e2ec] py-6 text-[#556b82]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-5">
            ...
            <div className="flex items-center space-x-2 text-[#556b82] font-medium text-[13px] sm:text-[14px]">
            ...
            <div className="flex items-center space-x-3 text-[13px] text-[#556b82]">
              ...
              <span className="text-[#d9e2ec]">|</span>
              <span className="text-[13px] text-[#556b82]">© 2026 Incture. All rights reserved.</span>
            </div>
          </div>
        </footer>
      </body>
