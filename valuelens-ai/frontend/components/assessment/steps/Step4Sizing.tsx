  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-b border-[#d9e2ec] pb-5">
        ...
        <p className="text-[15px] sm:text-[16px] text-[#556b82] mt-2 font-normal leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left Inputs (7 Cols) */}
        <div className="lg:col-span-7 bg-white rounded-2xl border border-[#d9e2ec] p-7 sm:p-8 shadow-xs space-y-6">
          <div className="flex items-center space-x-3.5 border-b border-[#d9e2ec] pb-4">
            <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#0070f2]">
              <Mail className="w-5 h-5" />
            </div>
            <h3 className="text-[18px] sm:text-[19px] font-bold text-[#1d2d3e]">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-12 text-[15px] font-mono border border-[#d9e2ec] rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-[#0070f2] focus:border-[#0070f2] focus:outline-none bg-white text-[#1d2d3e] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  placeholder="0"
                />
                <span className="absolute right-4 top-3.5 text-[13px] text-[#556b82] font-semibold">
                  messages / month
                </span>
              </div>
              <span className="text-[13px] text-[#556b82] mt-2 block">
        ...
        <div className="lg:col-span-5 bg-white rounded-2xl border border-[#d9e2ec] p-7 sm:p-8 shadow-xs flex flex-col items-center justify-between text-center space-y-6">
          <div className="space-y-1">
            <span className="text-[13px] font-bold text-[#0070f2] uppercase tracking-wider block">
              Throughput Scale Dynamic Preview
            </span>
            <h4 className="text-[17px] font-bold text-[#1d2d3e]">
          ...
          <div className="w-full flex items-end justify-center space-x-8 py-6 h-52">
            ...
            <div className="flex flex-col items-center space-y-2">
              <span className="text-[14px] font-bold font-mono text-[#0070f2]">
              ...
              />
              <span className="text-[14px] font-semibold text-[#1d2d3e]">Current</span>
            </div>

            {/* Expected Bar */}
            <div className="flex flex-col items-center space-y-2">
              <span className="text-[14px] font-bold font-mono text-[#107e3e]">
              ...
              />
              <span className="text-[14px] font-semibold text-[#1d2d3e]">Expected</span>
            </div>
          </div>

          <span className="text-[13px] font-bold text-[#107e3e] bg-emerald-50 px-4 py-2.5 rounded-lg border border-emerald-200">
      ...
      <div className="flex items-center justify-between pt-6 border-t border-[#d9e2ec]">
        <button
          type="button"
          onClick={onBack}
          className="h-12 px-7 text-[15px] font-semibold text-[#1d2d3e] bg-white border border-[#d9e2ec] rounded-xl hover:bg-slate-50 transition-colors flex items-center space-x-2 shadow-xs cursor-pointer"
        >
        ...
        <button
          type="button"
          onClick={onContinue}
          className="h-12 px-7 text-[15px] font-semibold text-white bg-[#0070f2] hover:bg-[#0057d2] rounded-xl shadow-xs transition-all flex items-center space-x-2 cursor-pointer"
        >
